...
const copy = {
  en: {
    ...
    researchBody: "Through camera trapping, field surveys, biodiversity inventories, and restoration assessments, OneK continuously monitors ecological change. Effective conservation begins with long-term data and a deeper understanding of nature.",
  ...
  zh: {
    ...
    researchBody: "通过红外相机、定点监测、物种记录和生态恢复评估，OneK 持续追踪热带雨林生态系统的变化。真正有效的保护，建立在长期的数据积累与对自然的深入理解之上。",
