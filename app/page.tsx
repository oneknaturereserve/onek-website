...
const copy = {
  en: {
    ...
    nonprofitBody: "Asociación ONEK de Conservación de Biodiversidad Costa Rica (Registration No. 3-002-971175) advances biodiversity conservation, restoration, research, environmental education, and community participation.",
  ...
  zh: {
    ...
    nonprofitKicker: "非营利组织",
    nonprofitTitle: "守护雨林，保护生命。",
    nonprofitBody: "Asociación ONEK de Conservación de Biodiversidad Costa Rica（注册号 3-002-971175）致力于生物多样性保护、生态恢复、科学研究、环境教育与社区参与。",
    support: "支持保护行动",
